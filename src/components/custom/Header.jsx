    ...
    return (
      <div className="bg-white rounded-xl shadow-lg p-4 flex flex-col items-center text-center">
        ...
        <div className="mt-4 flex justify-between w-full px-6">
          <button className="text-main" onClick={() => setOpenDialog(true)}>Add account</button>
          <button className="text-main" onClick={handleLogout}>Sign out</button>
        </div>
    ...
    <div className="flex h-[9vh] shadow-md justify-between items-center px-4 md:px-12 py-4 bg-white bg-opacity-30 z-50 relative">
      <Link to={"/"}>
        <div className="flex gap-2 items-center">
          <img src={logo} className="w-8 h-8 md:w-11 md:h-11" alt="journey Logo" />
      ...
      <div className="hidden md:flex justify-center items-center space-x-6">
        <Link to="/" className="text-blue flex items-center gap-1 hover:text-main ">
        ...
        <Link to="/contact" className="text-blue flex items-center gap-1 hover:text-main ">
        ...
        <Link to={"/Create-trip"} className="text-blue flex items-center gap-1 hover:text-main ">
        ...
        <Link to="/contact-us" className="text-blue flex items-center gap-1 hover:text-main ">
      ...
      <div>
        {user ? (
          ...
          <Button size="sm" className="px-6 text-white" onClick={() => setOpenDialog(true)}>Sign In</Button>
        )}
      </div>
      ...
      />
            ...
            {/* Mobile Layout: Fixed bottom navigation bar */}
              <div className="md:hidden fixed z-50 bottom-0 w-full bg-white flex justify-around items-center py-4 shadow-inner" style={{ boxShadow: ' 0 4px 12px rgba(0, 0, 0, 0.5)' }}>
          <Link to="/" className="text-blue flex flex-col items-center hover:text-main hover:font-bold">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-house" viewBox="0 0 16 16">
              <path d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a.5.5 0 0 0 .708.708L2 8.207V13.5A1.5 1.5 0 0 0 3.5 15h9a1.5 1.5 0 0 0 1.5-1.5V8.207l.646.647a.5.5 0 0 0 .708-.708L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293zM13 7.207V13.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V7.207l5-5z" />
            </svg>
          </Link>

          <Link to="/contact" className="text-blue flex flex-col items-center hover:text-main hover:font-bold">
          ...
          <Link to={"/Create-trip"} className="text-blue flex flex-col items-center hover:text-main hover:font-bold">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-globe-central-south-asia" viewBox="0 0 16 16">
              <path d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0M4.882 1.731a.48.48 0 0 0 .14.291.487.487 0 0 1-.126.78l-.291.146a.7.7 0 0 0-.188.135l-.48.48a1 1 0 0 1-1.023.242l-.02-.007a1 1 0 0 0-.462-.04 7 7 0 0 1 2.45-2.027m-3 9.674.86-.216a1 1 0 0 0 .758-.97v-.184a1 1 0 0 1 .445-.832l.04-.026a1 1 0 0 0 .152-1.54L3.121 6.621a.414.414 0 0 1 .542-.624l1.09.818a.5.5 0 0 0 .523.047.5.5 0 0 1 .724.447v.455a.8.8 0 0 0 .131.433l.795 1.192a1 1 0 0 1 .116.238l.73 2.19a1 1 0 0 0 .949.683h.058a1 1 0 0 0 .949-.684l.73-2.189a1 1 0 0 1 .116-.238l.791-1.187A.45.45 0 0 1 11.743 8c.16 0 .306.084.392.218.557.875 1.63 2.282 2.365 2.282l.04-.001a7.003 7.003 0 0 1-12.658.905Z" />
            </svg>
            
          </Link>

          <Link to="/contact-us" className="text-blue flex flex-col items-center hover:text-main hover:font-bold">

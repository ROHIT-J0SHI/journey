...
function Header() {
  ...
  return (
    <div className="flex h-[9vh] shadow-md justify-between items-center px-4 md:px-12 py-4 bg-white bg-opacity-30 z-50 relative">
      ...
      <div className="hidden md:flex justify-center items-center space-x-6">
        ...
        <Link to="/contact-us" className="text-blue flex items-center gap-1 hover:text-main ">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-telephone" viewBox="0 0 16 16">
            <path d="M3.654 1.328a.678.678 0 0 0-1.015-.063L1.605 2.3c-.483.484-.661 1.169-.45 1.77a17.6 17.6 0 0 0 4.168 6.608 17.6 17.6 0 0 0 6.608 4.168c.6.211 1.286.033 1.77-.45l1.036-1.034a.678.678 0 0 0-.063-1.015l-2.5-2a.678.678 0 0 0-.58-.137l-2.168.542a1.745 1.745 0 0 1-1.671-.457l-2-2a1.745 1.745 0 0 1-.457-1.67l.541-2.168a.678.678 0 0 0-.137-.581l-2-2Z" />
          </svg>
          Contact Us
        </Link>
      </div>
      ...
      <Popover>
        <PopoverTrigger>
          <img src={profilepic} className="rounded-full w-8 h-8 cursor-pointer" alt="Profile" />
        </PopoverTrigger>
      ...
      <div className="md:hidden bg-gray-100 flex items-center gap-6 fixed bottom-0 left-0 right-0 py-2 shadow-lg justify-around z-50">
        <Link to="/" className="text-blue hover:text-main">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-house" viewBox="0 0 16 16">
            <path d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a.5.5 0 0 0 .708.708L2 8.207V13.5A1.5 1.5 0 0 0 3.5 15h9a1.5 1.5 0 0 0 1.5-1.5V8.207l.646.647a.5.5 0 0 0 .708-.708L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293zM13 7.207V13.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V7.207l5-5z" />
          </svg>
        </Link>
        <Link to="/Create-trip" className="text-blue hover:text-main">
        ...
        <Link to="/contact-us" className="text-blue hover:text-main">
      ...
      {/* SignIn Dialog */}
      <SignInDialog isOpen={openDialog} onClose={() => setOpenDialog(false)} />
    </div>
  );
}

...
function Header() {
  ...
  return (
    <div className="flex h-[9vh] shadow-md justify-between items-center px-4 md:px-12 py-4 bg-white bg-opacity-30 z-50 relative">
      ...
      <div className="md:hidden fixed bottom-0 w-[100vw] bg-white flex justify-around items-center py-3 shadow-inner">
        ...
        <Link to="/Create-trip" className="text-blue flex flex-col items-center hover:text-main ">
